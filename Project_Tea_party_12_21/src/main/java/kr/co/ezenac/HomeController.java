...
//    @PostMapping("/checkId")
//    @ResponseBody
//    public String check_Id(@RequestBody Map<String, String> map) {
//        String getId = map.get("getId");
//        String check = null;
//
//        System.out.println("getId " + getId);
//        MemberVO member = memberService.selectMember("getId");
//
//        if (member.getMem_id().equals(getId)) {
//            check = "N";
