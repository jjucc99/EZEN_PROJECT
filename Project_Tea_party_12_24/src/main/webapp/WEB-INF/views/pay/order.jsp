...
<br>
	...
	<h4>배송 정보</h4>	
		<input type="checkbox" name="check" onclick="getInfo()">&nbsp;<b>기본정보로 배송</b><br>
		<div id="memInfo">
		<b>주문자 정보</b><br>
		...
		<div id="ordInfo">
		<b>수취인 정보</b><br>
		수취인: <input type="text" id="ord_receiver" name="ord_receiver" value=""><br>
		전화번호: <input type="text" name="ord_phone"><br>
		주소 <input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
		<input type="text" id="sample6_postcode" placeholder="우편번호" name="ord_addr1" size="10px"><br>
		<input type="text" id="sample6_address" placeholder="주소" name="ord_addr2" size="25px"><br>
		<input type="text" id="sample6_extraAddress" placeholder="상세주소" name="ord_addr3" size="25px"><br>
		</div>
		<br>

		<div class="payment">
		<h4>결제 수단</h4>
		<input type="radio" name="pay_no" value="1">계좌이체
		<input type="radio" name="pay_no" value="2">카드
		</div>
		
		<hr>
		<input type="button" value="주문하기" onclick="finalOrder()"> &nbsp; <input type="button" value="주문취소" onclick="history.back(-1);">
	</form>
	<%
		} else {
	%>
