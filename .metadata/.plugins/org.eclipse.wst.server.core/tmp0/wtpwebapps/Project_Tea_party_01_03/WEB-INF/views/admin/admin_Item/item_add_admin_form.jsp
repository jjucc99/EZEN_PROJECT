...
%>
	...
	<section>
      <div class="item_info_container container">
        ...
        <div class="item_info_container_description">
          <div class="item_info_container_description_img"><img src="resources/img/NO_IMAGE.png" alt="없음" id="original">
          <form action="addItem.ad" method="post" name="frm" enctype="multipart/form-data">
          이미지<input type="file" name="image" id="img" onchange="fileChange(this)"/>
          ...
          상품정보: <input type="text" name="item_information" placeholder="상품 설명"></div>
        </div>
        <div class="item_info_container_header">
          ...
          <div class="item_info_container_header_category">
           카테고리: <select id="selectBox" name="cate_code">
	...
	<option value="5">티웨어</option>
          ...
          <div class="item_info_container_header_name">
            상품명: <input type="text" name="item_name" placeholder="상품명">
          </div>
        <!-- </div>
        <div class="item_info_container_body"> -->
          <div class="item_info_container_body_price">
            가격:<input type="number" name="item_price" placeholder="가격">
          </div>
