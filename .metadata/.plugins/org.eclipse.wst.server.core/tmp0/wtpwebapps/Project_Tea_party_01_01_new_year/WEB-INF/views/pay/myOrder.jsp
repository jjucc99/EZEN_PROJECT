      ...
      <div class="order_container">
        ...
        <div class="order_container_items">
          ...
          <div class="order_container_items_item_box">
            <div class="order_container_img"><a href="orderItem.pay?ord_no=${ol.ord_no}"><img src="<c:url value='/image/${ol.imgPath}'/>"></a></div>
            
            <div class="order_container_text">
              <div class="order_container_text_name"><a href="orderItem.pay?ord_no=${ol.ord_no}">${ol.rep_name}</a></div>
              <div class="order_container_text_count"><a href="orderItem.pay?ord_no=${ol.ord_no}"><c:if test="${ol.ord_count!=0}">외 ${ol.ord_count} 개</c:if></a></div>
              <div class="order_container_text_sum"><a href="orderItem.pay?ord_no=${ol.ord_no}"><fmt:formatNumber value="${ol.ord_price}"/>원</a></div>
            </div>
