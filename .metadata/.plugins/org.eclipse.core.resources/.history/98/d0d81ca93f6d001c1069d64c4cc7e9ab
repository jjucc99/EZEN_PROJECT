      ...
      <div class="review_container">
        ...
        <div class="review_container_box">
          <div class="review_container_header">
            ...
            <div class="review_container_header_name">작성자: 관리자</div>
            <div class="review_container_header_title">제목: ${board.board_sub}</div>
            <div class="review_container_header_day">작성일자: <fmt:formatDate value="${board.board_date}"/></div>
          </div>
          <div class="review_container_context">
            <!-- <div class="review_container_context_img"></div> -->
            <div class="review_container_context_text"><textarea readonly="readonly" style="resize: none;">${board.board_content}</textarea></div>
          </div>
          <div class="review_container_btn">
            <input type="button" value="공지 리스트로 이동" onclick="location.href='noticeList.board'" />
          </div>
        </div>
      </div>
    </section>
