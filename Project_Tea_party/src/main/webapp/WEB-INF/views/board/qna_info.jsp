      ...
      <div class="qna_container">
        ...
        <div class="qna_container_context">
          <div class="qna_container_context_title">
            ...
            <div class="qna_container_context_title_title">제목: <input type="text" name="board_sub" value="${board.board_sub}"></div>
            <div class="qna_container_context_title_day">작성일자: <fmt:formatDate value="${board.board_date}"/></div>
          </div>
          <div class="qna_container_context_context"><textarea id="board_content" name="board_content">${board.board_content}</textarea></div>
		...
		<textarea id="reply_content" name="reply_content" placeholder="댓글을 입력하세요" style="resize: none;"></textarea>
