   ...
   <%  String checkLogin = (String) session.getAttribute("checkLogin");
	...
	<input type="hidden" name="imgFlag" id="imgFlag" value="Y">
          ...
          <div class="review_container_header">
            ...
            <div class="review_container_header_title">제목: <input type="text" name="r_board_sub" value="${review.r_board_sub}"><br></div>
            <div class="review_container_header_day">작성일자: <fmt:formatDate value="${review.r_board_date}"/></div>
          </div>
          <div class="review_container_context">
            <div class="review_container_context_img">
            	<img alt="없음" src="<c:url value='/image/${review.img_path}'/>" id="original">
            <br><input type="file" name="image" id="img" onchange="fileChange(this)"/></div>
            <div class="review_container_context_text"><textarea name="r_board_content">${review.r_board_content}</textarea></div>
          </div>
